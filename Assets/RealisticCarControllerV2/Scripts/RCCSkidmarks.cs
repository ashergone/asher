...
public class RCCSkidmarks : MonoBehaviour {
	...
	public int maxMarks = 50000;			// Maximum number of marks total handled by one instance of the script.
...
//	void Update () {
//		AddSkidMark (hall.transform.position, hall.transform.position, 0.5f, 100);
//	}
